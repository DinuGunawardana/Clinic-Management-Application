...
public class AddAngiogram2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_angiogram2);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String angiogram2 = edtangiogram1.getText().toString().trim();
                final String Date2 = Date.toString();

                if (!(userId.isEmpty() && angiogram2.isEmpty() && imageUrl!=null)){
                    progressDialog.setTitle("Uploading...");
                    progressDialog.show();

                    StorageReference filepath = mStorage.getReference().child(userId).child("Angiogram2").child(imageUrl.getLastPathSegment());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    newPost.child("angiogram2").setValue(angiogram2);
                                    newPost.child("angiogram2Image").setValue(task.getResult().toString());
